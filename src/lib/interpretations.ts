...
export const traitInterpretations: TraitInterpretation[] = [
  {
    ...
    interpretations: {
      ...
      moderate: "You show a balanced approach to new experiences and ideas. You can appreciate both innovation and tradition, adapting your approach based on the situation. This flexibility allows you to engage with novel concepts while also valuing practical considerations.",
  ...
  },
  {
    ...
    interpretations: {
      ...
      moderate: "You show a balanced approach to organization and flexibility. You can be methodical when needed while also adapting to changing circumstances. This allows you to meet responsibilities while remaining responsive to unexpected situations.",
  ...
  },
  {
    ...
    interpretations: {
      ...
      moderate: "You show a balanced social orientation. You can enjoy social interactions while also appreciating time alone. This flexibility allows you to adapt to various social situations and find energy from both group activities and solitary pursuits.",
  ...
  },
  {
    ...
    interpretations: {
      ...
      moderate: "You show a balanced approach to interpersonal interactions. You can be cooperative and empathetic while also being willing to assert your position when needed. This allows you to maintain relationships while still advocating for your interests.",
  ...
  },
  {
    ...
    interpretations: {
      ...
      moderate: "You show a balanced emotional responsiveness. You experience a range of emotions while generally maintaining equilibrium. This allows you to be attuned to emotional cues while also maintaining stability in various situations.",
...
export const facetInterpretations: FacetInterpretation[] = [
  // Openness Facets
  {
    ...
    interpretations: {
      ...
      moderate: "You balance practical thinking with occasional imaginative exploration, able to engage with both realistic and creative perspectives as situations require.",
  ...
  },
  {
    ...
    interpretations: {
      ...
      moderate: "You appreciate beauty and art in moderation, enjoying aesthetic experiences while not making them a central focus of your life.",
  ...
  },
  {
    ...
    interpretations: {
      ...
      moderate: "You have a balanced awareness of your emotions, neither overly detached nor intensely focused on your emotional experiences.",
  ...
  },
  {
    ...
    interpretations: {
      ...
      moderate: "You balance enjoyment of routine with occasional willingness to try new things, adapting your approach based on the situation.",
  ...
  },
  {
    ...
    interpretations: {
      ...
      moderate: "You engage with intellectual topics when relevant while also appreciating practical, concrete approaches to problems.",
  ...
  },
  {
    ...
    interpretations: {
      ...
      moderate: "You balance respect for tradition with openness to change, evaluating new and established approaches on their merits.",
  ...
  // Conscientiousness Facets
  {
    ...
    interpretations: {
      ...
      moderate: "You have a realistic sense of your capabilities, confident in some areas while recognizing limitations in others.",
  ...
  },
  {
    ...
    interpretations: {
      ...
      moderate: "You maintain reasonable organization while not being overly rigid about neatness or structure in your environment.",
  ...
  },
  {
    ...
    interpretations: {
      ...
      moderate: "You balance respect for rules and obligations with pragmatic flexibility when circumstances warrant.",
  ...
  },
  {
    ...
    interpretations: {
      ...
      moderate: "You pursue achievement in areas important to you while maintaining balance and not being driven solely by accomplishment.",
  ...
  },
  {
    ...
    interpretations: {
      ...
      moderate: "You can maintain focus and persistence when motivated, though you may sometimes struggle with tasks that don't engage you.",
  ...
  },
  {
    ...
    interpretations: {
      ...
      moderate: "You balance thoughtful deliberation with timely action, considering options without excessive delay.",
  ...
  // Extraversion Facets
  {
    ...
    interpretations: {
      ...
      moderate: "You can be warm and friendly when appropriate while also being comfortable maintaining professional distance.",
  ...
  },
  {
    ...
    interpretations: {
      ...
      moderate: "You enjoy social gatherings in moderation, comfortable in groups but also appreciating quiet time.",
  ...
  },
  {
    ...
    interpretations: {
      ...
      moderate: "You can assert yourself and take charge when needed while also being comfortable following others' lead.",
  ...
  },
  {
    ...
    interpretations: {
      ...
      moderate: "You balance activity with rest, maintaining a sustainable pace that includes both productive periods and downtime.",
  ...
  },
  {
    ...
    interpretations: {
      ...
      moderate: "You enjoy occasional excitement while also appreciating calm and predictability in your daily life.",
  ...
  },
  {
    ...
    interpretations: {
      ...
      moderate: "You experience and express positive emotions while maintaining a balanced, realistic outlook.",
  ...
  // Agreeableness Facets
  {
    ...
    interpretations: {
      ...
      moderate: "You balance trust with appropriate caution, giving people the benefit of the doubt while remaining aware of potential risks.",
  ...
  },
  {
    ...
    interpretations: {
      ...
      moderate: "You generally adhere to ethical standards while recognizing that situations sometimes call for pragmatic flexibility.",
  ...
  },
  {
    ...
    interpretations: {
      ...
      moderate: "You balance concern for others with attention to your own needs, helping when you can without neglecting yourself.",
  ...
  },
  {
    ...
    interpretations: {
      ...
      moderate: "You can cooperate and compromise while also being willing to stand firm on important issues.",
  ...
  },
  {
    ...
    interpretations: {
      ...
      moderate: "You can acknowledge your achievements appropriately while avoiding excessive boasting or false modesty.",
  ...
  },
  {
    ...
    interpretations: {
      ...
      moderate: "You feel compassion for others while maintaining enough emotional distance to offer practical help.",
  ...
  // Neuroticism Facets (inverted for Emotional Stability framing)
  {
    ...
    interpretations: {
      ...
      moderate: "You experience normal levels of concern, worried when appropriate but generally able to manage anxious feelings.",
  ...
  },
  {
    ...
    interpretations: {
      ...
      moderate: "You experience and express anger appropriately, feeling frustrated when warranted but generally maintaining control.",
  ...
  },
  {
    ...
    interpretations: {
      ...
      moderate: "You experience normal fluctuations in mood, feeling down sometimes but generally maintaining a sense of wellbeing.",
  ...
  },
  {
    ...
    interpretations: {
      ...
      moderate: "You have normal social awareness without excessive concern about others' judgments of you.",
  ...
  },
  {
    ...
    interpretations: {
      ...
      moderate: "You can generally control impulses while occasionally indulging, maintaining a reasonable balance.",
  ...
  },
  {
    ...
    interpretations: {
      ...
      moderate: "You handle normal stresses effectively while recognizing that exceptional pressures can be challenging.",
...
export function getScoreRangeLabel(range: ScoreRange): string {
  switch (range) {
    case 'low': return 'Lower Range';
    case 'moderate': return 'Moderate Range';
    case 'high': return 'Higher Range';
  }
}
 ...
 */
export function getTraitSummary(trait: BigFiveTrait, percentScore: number): string {
  const range = getScoreRange(percentScore);
